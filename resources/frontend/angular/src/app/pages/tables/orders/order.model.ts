export class Order {
  ...
  constructor(order) {
    ...
    // this.billing_street_address2 = order.billing_street_address2;
    // this.billing_email = order.email_address;
    // this.billing_telephone = order.customers_telephone;
    // this.billing_postcode = order.billing_postcode;
    ...
    this.totals_breakdown = order.totals_breakdown;
    this.transaction_id = order.transaction_id;
    this.upsell_product_id = order.upsell_product_id;
    this.upsell_product_quantity = order.upsell_product_quantity;
    this.website_received = order.website_received;
    this.website_sent = order.website_sent;
