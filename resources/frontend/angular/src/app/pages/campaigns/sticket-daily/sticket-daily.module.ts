...
import { SticketDailyRoutingModule } from './sticket-daily-routing.module';
...
@NgModule({
  ...
  exports: [SticketDailyComponent],
  
})
export class SticketDailyModule { }
