...
import { GoldenTicketRoutingModule } from './golden-ticket-routing.module';
...
@NgModule({
  ...
  exports: [GoldenTicketComponent],
  
})
export class GoldenTicketModule { }
