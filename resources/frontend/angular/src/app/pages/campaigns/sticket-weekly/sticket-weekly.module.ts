...
import { SticketWeeklyRoutingModule } from './sticket-weekly-routing.module';
...
@NgModule({
  ...
  exports: [SticketWeeklyComponent],
  
})
export class SticketWeeklyModule { }
