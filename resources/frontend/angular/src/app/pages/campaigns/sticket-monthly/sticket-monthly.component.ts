  ...
  import { SticketMonthlyService } from './sticket-monthly.service';
  ...
  @Component({
    selector: 'fury-sticket-monthly',
    templateUrl: './sticket-monthly.component.html',
    styleUrls: ['./sticket-monthly.component.scss'],
    animations: [fadeInRightAnimation, fadeInUpAnimation]
  })
  export class SticketMonthlyComponent implements OnInit {
    ...
    constructor(private dialog: MatDialog, private goldenTicketService: SticketMonthlyService, private campaignService: CampaignService) {
    }
    ...
    ngOnInit() {
      this.getSubscription = this.campaignService.sticketMonthlyResponse$.subscribe(data => this.manageGetResponse(data));
      this.getData();
    ...
    async getData() {
      this.isLoading = true;
      await this.campaignService.getMonthlySticket()
        .then(tickets => {
  ...
  async refresh() {
    ...
    this.isLoading = true;
    await this.campaignService.refreshMonthlySticket()
      .then(tickets => {
        this.tickets = tickets.data;
        this.dataSource.data = tickets.data;
